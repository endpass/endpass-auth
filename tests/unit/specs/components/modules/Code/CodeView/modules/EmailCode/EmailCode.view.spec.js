...
import EmailCodeView from '@/components/modules/CodeRequest/modules/CodeView/modules/EmailCode/EmailCode.view';
...
describe('EmailCodeView', () => {
  let wrapper;
  const createWrapper = (options, props) =>
    shallowMount(EmailCodeView, {
      provide: {
        theme: 'default',
      },
      localVue,
  ...
  describe('render', () => {
    it('should correctly render component', () => {
      expect(wrapper.name()).toBe('EmailCodeView');
      expect(wrapper.html()).toMatchSnapshot();
    });

    it('should render form', () => {
      expect(wrapper.find('[data-test=email-code-form]').exists()).toBe(true);
      expect(wrapper.html()).toMatchSnapshot();
    });
  });
