...
import CodeOtp from '@/components/modules/CodeRequest/modules/CodeOtp';
...
describe('CodeRequestInteractor', () => {
  ...
  describe('render', () => {
    ...
    it('should render form', () => {
      expect(wrapper.find(CodeOtp).exists()).toBe(true);
      expect(wrapper.html()).toMatchSnapshot();
    });
  });
  ...
  describe('behavior', () => {
    describe('send code', () => {
      ...
      it('should send code on event', () => {
        ...
        wrapper.find(CodeOtp).vm.$emit('send-code');
      ...
      describe('loading status', () => {
        ...
        it('should pass isLoading as true', () => {
          ...
          expect(wrapper.find(CodeOtp).attributes().isloading).toBeTruthy();
        });
        ...
        it('should pass isLoading as false', () => {
          ...
          expect(wrapper.find(CodeOtp).attributes().isloading).toBeFalsy();
        });
      });
    ...
    describe('recover', () => {
      it('should emit recover event', () => {
        ...
        wrapper.find(CodeOtp).vm.$emit('recover');
    ...
    describe('submit', () => {
      it('should emit submit event', () => {
        ...
        wrapper.find(CodeOtp).vm.$emit('submit', { code });
