export default {
  ...
  'user:phone:read': 'Read phone',
  documents: 'Read all documents',
  'documents:status:read': 'Read document status',
  'documents:data:read': 'Read document content',
  'documents:image:read': 'Read image documents',
};
